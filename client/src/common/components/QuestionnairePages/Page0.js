...
// // client\src\common\components\QuestionnairePages\Page0.js
...
//         <h1 style={{ textAlign: "center", color: "rgba(0, 0, 0, 0)" }}>
//           -------------------------------------
//         </h1>
...
//         >
//           <DialogTitle
//             id="age-confirmation-dialog-title"
//             style={{
//               display: "flex",
    ...
    <>
      <div>
        ...
        {authToken ? (
          ...
          <>
            <h1 style={{ textAlign: 'center' }}>ברוכים הבאים</h1>
            <h2 style={{ textAlign: 'center' }}>אורח</h2>
          </>
        )}
      </div>
